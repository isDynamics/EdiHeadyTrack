...
print('Attempting EdiHeadyTrack import...')
import EdiHeadyTrack
print('EdiHeady track imported successfully')
...
project = u'EdiHeadyTrack'
copyright = u'2023, Thomas Aston'
author = u'Thomas Aston'
...
htmlhelp_basename = 'EdiHeadyTrackdoc'
...
latex_documents = [
  (master_doc, 'EdiHeadyTrack.tex', u'EdiHeadyTrack Documentation',
   u'Thomas Aston', 'manual'),
]
...
man_pages = [
    (master_doc, 'EdiHeadyTrack', u'EdiHeadyTrack Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'EdiHeadyTrack', u'EdiHeadyTrack Documentation',
   author, 'EdiHeadyTrack', 'One line description of project.',
   'Miscellaneous'),
]
